...
public class Evenement {
    ...
    public Evenement(int id,String n , String desc,Date da,String duree  , String dest , String type,String etat, String image , int nbp ,float prix ,int iduser )
    {
        this.idEvenement=id;
        this.nomEvenement=n ; 
    ...
    public Evenement(String n , String desc,Date da,String duree  , String dest , String type,String etat, String image , int nbp ,float prix ,int iduser )
    {
    ...
    public Evenement(String nomE, Date dateE, String destinationE, String typeE, String etatE, int nombreE,float prix) {
    ...
    public Evenement(String nomE, Date dateE, String destinationE, String typeE, String dureeE, String descriptionE, String etatE, int nombreE, float prixEve) {
       this.nomEvenement=nomE ; 
       this.dateEvenement=dateE ; 
       this.destination=destinationE; 
       this.type=typeE ; 
